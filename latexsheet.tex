...
For footnotes in headings:

\verb!\usepackage[stable]{footmisc}!
...
\verb!~\\!         &  In article, after the paragraph heading: begin new line. \\
...
\verb!address!         &  Address of publisher.  Not necessary for major
                                publishers.  \\
\verb!author!           &  Names of authors. No commas, only \verb!and!. \\
...
\verb!howpublished!     &  How it was published (usefull for giving an URL). \\
...
Edited by Ekaterina Titkova, 2013

https://github.com/katyatitkova/LaTeX-cheat-sheet
